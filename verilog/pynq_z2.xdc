...
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports {serial_out}]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {serial_in}]
set_property PULLTYPE PULLUP [get_ports {serial_in}]
# set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_tri_io[4]}]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {serial_clock}]
set_property PULLTYPE PULLUP [get_ports {serial_clock}]
...
## Raspberry PI 
set_property -dict { PACKAGE_PIN W18  IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[0]   }]; 
set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[1]   }]; 
set_property -dict { PACKAGE_PIN Y18  IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[2]   }]; 
set_property -dict { PACKAGE_PIN V6   IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[3]   }]; 
set_property -dict { PACKAGE_PIN Y6   IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[4]   }]; 
set_property -dict { PACKAGE_PIN U7   IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[5]   }]; 
set_property -dict { PACKAGE_PIN C20  IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[6]   }]; 
set_property -dict { PACKAGE_PIN V7   IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[7]   }]; 
set_property -dict { PACKAGE_PIN U8   IOSTANDARD LVCMOS33 } [get_ports { cartridge_nWR   }]; 
set_property -dict { PACKAGE_PIN W6   IOSTANDARD LVCMOS33 } [get_ports { cartridge_nRD   }]; 
set_property -dict { PACKAGE_PIN Y7   IOSTANDARD LVCMOS33 } [get_ports { cartridge_nCS   }]; 
set_property -dict { PACKAGE_PIN V8   IOSTANDARD LVCMOS33 } [get_ports { cartridge_nRST   }]; 
set_property -dict { PACKAGE_PIN V10  IOSTANDARD LVCMOS33 } [get_ports { cartridge_D[0]   }]; 
set_property -dict { PACKAGE_PIN F20  IOSTANDARD LVCMOS33 } [get_ports { cartridge_D[1]   }]; 
set_property -dict { PACKAGE_PIN W10  IOSTANDARD LVCMOS33 } [get_ports { cartridge_D[2]   }]; 
set_property -dict { PACKAGE_PIN F19  IOSTANDARD LVCMOS33 } [get_ports { cartridge_D[3]   }]; 
set_property -dict { PACKAGE_PIN U19  IOSTANDARD LVCMOS33 } [get_ports { cartridge_D[4]   }]; 
set_property -dict { PACKAGE_PIN Y16  IOSTANDARD LVCMOS33 } [get_ports { cartridge_D[5]   }]; 
set_property -dict { PACKAGE_PIN Y17  IOSTANDARD LVCMOS33 } [get_ports { cartridge_D[6]   }]; 
set_property -dict { PACKAGE_PIN Y19  IOSTANDARD LVCMOS33 } [get_ports { cartridge_D[7]   }]; 
set_property -dict { PACKAGE_PIN U18  IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[8]   }]; 
set_property -dict { PACKAGE_PIN B20  IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[9]   }]; 
set_property -dict { PACKAGE_PIN W8   IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[10]   }]; 
set_property -dict { PACKAGE_PIN Y8   IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[11]   }]; 
set_property -dict { PACKAGE_PIN B19  IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[12]   }]; 
set_property -dict { PACKAGE_PIN W9   IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[13]   }]; 
set_property -dict { PACKAGE_PIN A20  IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[14]   }]; 
set_property -dict { PACKAGE_PIN Y9   IOSTANDARD LVCMOS33 } [get_ports { cartridge_A[15]   }]; 
